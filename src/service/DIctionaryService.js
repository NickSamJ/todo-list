      ...
      <SimpleForm >
        <div className={classes.formWrapper} fullWidth>
          <div className={classes.formColumn}>
            <TextInput source="title" label="Language name" formClassName={classes.inputWrapper} required fullWidth/>
            <TextInput source="code" label="ISO language code" formClassName={classes.inputWrapper} required fullWidth/>
          </div>
          <div className={classes.formColumn}>
...
export const WordCreate = (props) => (
  <Create {...props}>
    <SimpleForm>
      ...
      <TextInput source="translate" label="Enter translate" validate={required()} />
      <ReferenceInput label="Language" source="language" defaultValue="zr9Cby6jE5RTx418yzy5" reference="languages">
      ...
      <SimpleForm>
        <div className={classes.formWrapper} fullWidth>
          ...
          <div className={classes.formColumn}>
            ...
            <DateInput source="lastupdate" options={{ disabled: true }} fullWidth/>
            <TextInput source="updatedby" options={{ disabled: true }}  fullWidth/>
            <DateInput source="createdate" options={{ disabled: true }} fullWidth/>
            <TextInput source="createdby" options={{ disabled: true }}  fullWidth/>
          </div>
        </div>

...
export const PostCreate = (props) => (
  <Create {...props} >
	<SimpleForm toolbar={<PostCreateToolbar />}>
	  ...
	  <TextInput source="excerpt"  multiline fullWidth inputProps={{ maxLength: 200 }} validate={required()}/>
...
export const PostEdit = (props) => (
  <Edit {...props}>
    <SimpleForm>
	  ...
	  <TextInput source="post_alias"  fullWidth label="Post alias (no spaces and symbols, except ' - ')" validate={required()}/>
      <RichTextInput source="body" fullWidth label="Post content" validate={required()}/>
